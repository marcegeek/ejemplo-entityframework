...
namespace EjemploEF.Controllers
{
    public class UsersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "UserId,FirstName,LastName,Email,Birthday,CityId")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "UserId,FirstName,LastName,Email,Birthday,CityId")] User user)
        {
            if (ModelState.IsValid)
            {
